        ...
        <nav class="bg-gray-800">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="-mr-2 flex md:hidden">
                        <!-- Mobile menu button -->
                        <button type="button" id="mobile-menu-button" class="relative inline-flex items-center justify-center 
                        rounded-md bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white 
            ...
            <div class="md:hidden " id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <x-nav-link-resp href="/" :active="request()->is('/')">Home</x-nav-link-resp>
                    <x-nav-link-resp href="/jobs" :active="request()->is('jobs')">Jobs</x-nav-link-resp>
                    <x-nav-link-resp href="/contact" :active="request()->is('contact')">Contact</x-nav-link-resp>
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="text-sm font-medium text-gray-400">jeffrey@example.com</div>
                        </div>
                        <button type="button"
